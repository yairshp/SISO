            ...
            if loss < best_loss:
                ...
                if args.save_weights and accelerator.is_main_process:
                    ...
                    if args.train_text_encoder:
                        ...
                        best_text_encoder_lora_layers = get_peft_model_state_dict(
                            best_text_encoder_one
                        )
                    else:
                        best_text_encoder_lora_layers = None

                    best_lora_params = {
                        "transformer": best_transformer_lora_layers,
                        "text_encoder": best_text_encoder_lora_layers,
                    }
